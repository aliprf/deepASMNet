...
class TFRecordUtility:
    ...
    def create_training_tensor(self, tfrecord_filename, batch_size, reduced=False):
        SHUFFLE_BUFFER = 100
        BATCH_SIZE = batch_size
        ...
        dataset = dataset.map(self.__parse_function, num_parallel_calls=32)
        ...
        image_raw, landmarks, pose, heatmap, image_name = iterator.get_next()
    ...
    def __parse_function(self, proto):
        ...
        heatmap = parsed_features['heatmap']
